...
const it: Dict = {
  ...
  "image.heroAlt": "Le colline e i vigneti dell’Oltrepò Pavese visti da Mulimù",
  "image.placeAlt": "Panorama delle colline dell’Oltrepò Pavese",
  "image.roomsAlt": "Interno di Mulimù con vista sulle colline",
  "brand.logoAlt": "Mulimù — Ospitalità rurale",
  "brand.identity": "Mulimù — Ospitalità rurale — Guest house",
  "a11y.changeLanguage": "Cambia lingua",
  "a11y.availableLanguages": "Lingue disponibili",
  "a11y.home": "Mulimù — Home",
  ...
  "a11y.footerNavigation": "Navigazione nel footer",
  "error.notFoundTitle": "Pagina non trovata",
  "error.notFoundBody": "La pagina che cerchi non esiste o è stata spostata.",
  "error.backHome": "Torna alla home",
  "error.loadTitle": "Questa pagina non si è caricata",
  "error.loadBody": "Qualcosa è andato storto. Puoi riprovare o tornare alla home.",
  "error.retry": "Riprova",
};
...
const en: Dict = {
  ...
  "image.heroAlt": "The hills and vineyards of the Oltrepò Pavese seen from Mulimù",
  "image.placeAlt": "Panorama of the Oltrepò Pavese hills",
  "image.roomsAlt": "Mulimù interior overlooking the hills",
  "brand.logoAlt": "Mulimù — Rural hospitality",
  "brand.identity": "Mulimù — Rural hospitality — Guest house",
  "a11y.changeLanguage": "Change language",
  "a11y.availableLanguages": "Available languages",
  "a11y.home": "Mulimù — Home",
  ...
  "error.loadTitle": "This page could not be loaded",
  "error.loadBody": "Something went wrong. You can try again or return home.",
...
const fr: Dict = {
  ...
  "image.heroAlt": "Les collines et les vignobles de l’Oltrepò Pavese vus depuis Mulimù",
  "image.placeAlt": "Panorama des collines de l’Oltrepò Pavese",
  "image.roomsAlt": "Intérieur de Mulimù avec vue sur les collines",
  "brand.logoAlt": "Mulimù — Hospitalité rurale",
  "brand.identity": "Mulimù — Hospitalité rurale — Maison d’hôtes",
  "a11y.changeLanguage": "Changer de langue",
  "a11y.availableLanguages": "Langues disponibles",
  "a11y.home": "Mulimù — Accueil",
  ...
  "error.loadTitle": "Cette page n’a pas pu être chargée",
  "error.loadBody": "Un problème est survenu. Vous pouvez réessayer ou revenir à l’accueil.",
...
const de: Dict = {
  ...
  "image.heroAlt": "Die Hügel und Weinberge des Oltrepò Pavese von Mulimù aus gesehen",
  "image.placeAlt": "Panorama der Hügel des Oltrepò Pavese",
  "image.roomsAlt": "Innenraum von Mulimù mit Blick auf die Hügel",
  "brand.logoAlt": "Mulimù — Ländliche Gastfreundschaft",
  "brand.identity": "Mulimù — Ländliche Gastfreundschaft — Gästehaus",
  "a11y.changeLanguage": "Sprache ändern",
  "a11y.availableLanguages": "Verfügbare Sprachen",
  "a11y.home": "Mulimù — Startseite",
  "a11y.mainNavigation": "Hauptnavigation",
  "a11y.openMenu": "Menü öffnen",
  "a11y.closeMenu": "Menü schließen",
  "a11y.mobileNavigation": "Mobile Navigation",
  "a11y.footerNavigation": "Navigation im Seitenfuß",
  ...
  "error.loadTitle": "Diese Seite konnte nicht geladen werden",
  "error.loadBody":
...
const nl: Dict = {
  ...
  "image.heroAlt": "De heuvels en wijngaarden van de Oltrepò Pavese gezien vanuit Mulimù",
  "image.placeAlt": "Panorama van de heuvels van de Oltrepò Pavese",
  "image.roomsAlt": "Interieur van Mulimù met uitzicht op de heuvels",
  "brand.logoAlt": "Mulimù — Landelijke gastvrijheid",
  "brand.identity": "Mulimù — Landelijke gastvrijheid — Guesthouse",
  "a11y.changeLanguage": "Taal wijzigen",
  "a11y.availableLanguages": "Beschikbare talen",
  "a11y.home": "Mulimù — Home",
  "a11y.mainNavigation": "Hoofdnavigatie",
  "a11y.openMenu": "Menu openen",
  "a11y.closeMenu": "Menu sluiten",
  "a11y.mobileNavigation": "Mobiele navigatie",
  "a11y.footerNavigation": "Navigatie in de voettekst",
  "error.notFoundTitle": "Pagina niet gevonden",
  "error.notFoundBody": "De pagina die je zoekt bestaat niet of is verplaatst.",
  "error.backHome": "Terug naar home",
  "error.loadTitle": "Deze pagina kon niet worden geladen",
  "error.loadBody": "Er is iets misgegaan. Probeer het opnieuw of ga terug naar home.",
